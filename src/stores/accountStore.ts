...
export const checkActiveNWC = () => {
  // Basic stub or implementation if needed, checking for NWC connection
  // For now, if no logic, we can keep empty or implement basic check
}
